...
const APP_NAME = "Эффект — цветы и шары в Тольятти";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Цветочный магазин Эффект в Тольятти на улице Мира, 95А. Букеты, шары, доставка. Цены из Яндекс Карт. Телефон +7 (996) 722-62-62.",
      },
